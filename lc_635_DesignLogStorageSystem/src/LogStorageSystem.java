...
/**
 ...
 time level for consideration. For example, start = "2017:01:01:23:59:59", end = "2017:01:02:23:59:59",
 ...
 retrieve("2016:01:01:01:01:01","2017:01:01:23:00:00","Hour"); // return [1,2], because you need to return all
...
class LogStorageSystem {
    ...
    public List<Integer> retrieve(String s, String e, String gra) {
        ...
        Map<String, List<Integer>> subMap = logs.subMap(
                s.substring(0, index) + min.substring(index), true,
                e.substring(0, index) + max.substring(index), true
        );
...
/**
 * Your LogStorageSystem object will be instantiated and called as such:
